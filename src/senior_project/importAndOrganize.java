...
public class importAndOrganize {
	public static void readFile() throws IOException { 
			...
			while (scan.hasNextLine() == true) {
				...
				if (readOut.equals(startValue)) {
					...
					while (scan.hasNextLine() == true) {
						...
						//TODO: Figure out WTF this just did. But i may have solved the fucking calc issue. 
						
						//System.out.println(readOut);
						
						
						
						//TODO: See if we can get the output there to go into the double testArray...
						//readOut.add(testArray);
						
						/*Float.parseFloat(readOut); //TODO: error on read here - need to figure out what this does. 
						//end of new attempt
						System.out.println(readOut);
						//readOut.toCharArray();
		...
		//	System.out.print(subVals.charAt(3));
			System.out.println();
			//System.out.println(values.get(6)); TODO: Figure out what that does. 
